...
## Conclusion
This was an interesting assignment to understand basics DT operations using Transportation data. Overall, this analysis provided valuable insights into the financial and operational performance of different transit agencies and modes. 
  
## Key points from this analysis

1. MTA New York City Transit had the most passenger trips.
